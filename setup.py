...
setup(
    name='CommenlyzerEngine',
    packages=['CommenlyzerEngine'],
    url='https://github.com/fsadannn/CommenlyzerEngine', # cambiar
    download_url='https://github.com/fsadannn/CommenlyzerEngine/tarball/{}'.format(VERSION), # cambiar
    license='MIT',
    author='Frank Sadan Naranjo Noda, Hian Cañizares Días',
    author_email='fsadannn@gmail.com, hiancdtrsnm@gmail.com',
    # TODO: escribir la descripcion
    description='',
